...
function preload() {
  ...
  pinguImage = loadImage("img1.png");
  snowmanImage = loadImage("nanna3.png");
  iglooImage = loadImage("nanna1.png");
  snowman2Img = loadImage("snowman.gif");
  boysImg = loadImage("igloo.png");
  boys2Img = loadImage("nanna2.png");
}
...
function setup() {
  ...
  snowman = createSprite(400, 550);
  snowman.addImage(snowmanImage);
  snowman.scale = 0.4;

  snowman2 = createSprite(800,530);
